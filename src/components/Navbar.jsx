...
//       <NavButton title="Menu" customFunc={()=>handleClick((prevActiveMenu)=>!prevActiveMenu)} color="blue" icon={<AiOutlineMenu />} />
//       <div className="flex">
      ...
      <div className="flex">
        ...
        <TooltipComponent content="Profile" position="BottomCenter">
          ...
          >
            ...
            <p>
              <span className="text-gray-400 text-14">Hi,</span>{' '}
              <span className="text-gray-600 font-bold ml-1 text-14">Ram</span>
            </p>
            <MdKeyboardArrowDown className="text-gray-400 text-14" />
          </div>
        </TooltipComponent>
